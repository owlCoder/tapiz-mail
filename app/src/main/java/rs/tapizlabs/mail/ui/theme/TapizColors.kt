...
private fun skinRamp(skin: MailSkin, dark: Boolean): SkinRamp = when (skin) {
    ...
    MailSkin.Default -> if (dark) SkinRamp(
        ...
        txt1 = hex(0xffffff), txt2 = hex(0xd1d0d3), txt3 = hex(0xa2a1a6),
        ...
        txt1 = hex(0x171321), txt2 = hex(0x45424d), txt3 = hex(0x74717a),
    ...
    MailSkin.Ocean -> if (dark) SkinRamp(
        ...
        txt1 = hex(0xffffff), txt2 = hex(0xd0d3da), txt3 = hex(0xa0a6b2),
        ...
        txt1 = hex(0x101725), txt2 = hex(0x414d61), txt3 = hex(0x6b7789),
    ...
    MailSkin.Forest -> if (dark) SkinRamp(
        ...
        txt1 = hex(0xffffff), txt2 = hex(0xd0d6d1), txt3 = hex(0xa0aaa2),
        ...
        txt1 = hex(0x121a14), txt2 = hex(0x414d43), txt3 = hex(0x6c786e),
    ...
    MailSkin.Rose -> if (dark) SkinRamp(
        ...
        txt1 = hex(0xffffff), txt2 = hex(0xd5cfd2), txt3 = hex(0xa89fa4),
        ...
        txt1 = hex(0x1c1218), txt2 = hex(0x4c4148), txt3 = hex(0x786f74),
    ...
    MailSkin.Graphite -> if (dark) SkinRamp(
        ...
        txt1 = hex(0xffffff), txt2 = hex(0xd2d2d5), txt3 = hex(0xa2a2a8),
        ...
        txt1 = hex(0x131316), txt2 = hex(0x434349), txt3 = hex(0x717178),
    ...
    MailSkin.Sand -> if (dark) SkinRamp(
        ...
        txt1 = hex(0xffffff), txt2 = hex(0xd6d1cb), txt3 = hex(0xa8a199),
        ...
        txt1 = hex(0x1c150e), txt2 = hex(0x4c443a), txt3 = hex(0x79726a),
    ...
    MailSkin.Crimson -> if (dark) SkinRamp(
        ...
        txt1 = hex(0xffffff), txt2 = hex(0xd5cfd0), txt3 = hex(0xa89fa1),
        ...
        txt1 = hex(0x1c1213), txt2 = hex(0x4c4142), txt3 = hex(0x786f71),
    ...
    MailSkin.Aurora -> if (dark) SkinRamp(
        ...
        txt1 = hex(0xffffff), txt2 = hex(0xd0d6d6), txt3 = hex(0xa0aaaa),
        ...
        txt1 = hex(0x101a19), txt2 = hex(0x414d4c), txt3 = hex(0x6c7877),
